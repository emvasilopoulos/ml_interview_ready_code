...
from mnn.vision.models.vision_transformer.patchers.grid_reshape import GridReshaper
...
class VitObjectDetectionNetwork3(torch.nn.Module):
...
class VitObjectDetectionNetwork4(torch.nn.Module):
    ...
    def __init__(
        ...
        # Layers
        # 0 - Patcher without embeddings (just reshape grids to vectors)
        self.patcher = GridReshaper(self.expected_image_size)
